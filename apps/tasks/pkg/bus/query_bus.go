...
func (b *QueryBus) RegisterHandler(queryType IQuery, handler interface{}) error {
...
func (b *QueryBus) Dispatch(ctx context.Context, query IQuery) (interface{}, error) {
